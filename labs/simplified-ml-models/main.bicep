...
// 4. Storage Account (for Azure ML workspace)
...
// 5. Key Vault (for Azure ML workspace)
...
// 6. Container Registry (for Azure ML model images)
...
// 8. Azure ML Online Endpoint (deployment created later in the notebook)
...
// 9. Role Assignment - APIM managed identity gets AzureML Data Scientist role on ML workspace
...
// 11. MCP Server wrapping the ML Prediction API
...
output mlPredictionApiEndpoint string = mlPredictionAPIModule.outputs.endpoint
